            ...
            <div class="flex flex-col space-y-2">
                ...
                <div class="flex items-center space-x-4">
                    <label class="flex items-center space-x-2">
                        <input type="radio" name="jenis_kelamin" value="laki-laki" class="w-4 h-4"
                            @checked($anggota->jenis_kelamin == 'laki-laki')>
                        <span>Laki-laki</span>
                    </label>
                    <label class="flex items-center space-x-2">
                        <input type="radio" name="jenis_kelamin" value="perempuan" class="w-4 h-4"
                            @checked($anggota->jenis_kelamin == 'perempuan')>
                        <span>Perempuan</span>
                    </label>
                </div>
            </div>
